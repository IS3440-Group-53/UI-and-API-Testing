...
//    WebDriverWait wait;
//
//    // Locators for Admin menu and page
...
//
//    // Locators for Add User and Edit User
...
//    }
//
//    // Save the user details (either new or edited)
...
//        By userRow = By.xpath("//td[text()='" + username + "']/..");
//        By editUserButton = By.xpath(".//button[text()='Edit']");
//        WebElement userRowElement = wait.until(ExpectedConditions.visibilityOfElementLocated(userRow));
//        userRowElement.findElement(editUserButton).click();
//
//        // Edit user fields
//        selectUserRole(role);
